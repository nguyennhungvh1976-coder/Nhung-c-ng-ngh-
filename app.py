...
<div class="main-header">
    ...
    <p>Tác giả: nguyễn Thị Nhung - Trường Tiểu học Vĩnh hảo - ĐT: 094 9036 847</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - nguyễn Thị Nhung - Trường Tiểu học vĩnh Hảo - ĐT: 094 9036 847</div>", unsafe_allow_html=True)
